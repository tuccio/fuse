...
//	inline std::enable_if_t<is_scalar_matrix<VectorType>::value, VectorType>
...
//
//	template <typename VectorType>
//	inline std::enable_if_t<is_float_matrix<VectorType>::value, VectorType>
//		operator/ (const VectorType & a, typename VectorType::scalar b)
//	{
...
//
//	template <typename VectorType>
//	inline std::enable_if_t<is_scalar_matrix<VectorType>::value, bool>
//		operator== (const VectorType & a, const VectorType & b)
//	{
//		return equals(a, b);
//	}
...
//		{
//			inline static void multiply(typename VectorType::scalar & r, const VectorType & a, const VectorType & b)
//			{
...
//
//	template <typename VectorType>
//	inline VectorType multiply(const VectorType & a, const VectorType & b)
//	{
//		VectorType r;
