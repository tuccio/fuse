...
{
	FUSE_LOOSEOCTREE_FRONT_BOTTOM_LEFT = 0, // 000
	FUSE_LOOSEOCTREE_FRONT_BOTTOM_RIGHT = 1, // 001
	FUSE_LOOSEOCTREE_FRONT_TOP_LEFT = 2, // 010
	FUSE_LOOSEOCTREE_FRONT_TOP_RIGHT = 3, // 011
	FUSE_LOOSEOCTREE_BACK_BOTTOM_LEFT = 4, // 100
	FUSE_LOOSEOCTREE_BACK_BOTTOM_RIGHT = 5, // 101
	FUSE_LOOSEOCTREE_BACK_TOP_LEFT = 6, // 110
	FUSE_LOOSEOCTREE_BACK_TOP_RIGHT = 7, // 111
};
...
namespace fuse
{
	...
	*/
	...
	private:
		...
		inline void ray_pick(morton_code currentLocation,
		                     const aabb & current,
		                     const ray  & ray,
		                     float & minDistance,
		                     Object * & object);
