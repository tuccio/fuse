...
namespace fuse
{
	...
	namespace detail
	{
		...
		struct matrix_cwise
		{
			...
			inline static void divide(MatrixType & r, const MatrixType & a, const MatrixType & b)
			{
		...
		struct matrix_minus_impl
		{
			...
			inline static matrix_type minus(const matrix_type & a)
			{
				matrix_type r;
		...
		struct matrix_scale_impl
		{
			...
			inline static matrix_type divide(const matrix_type & a, const matrix_type & b)
			{
				matrix_type r;
